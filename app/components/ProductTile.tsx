...
export function ProductTile({ product }: ProductTileProps) {
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow duration-200">
            ...
            <div className="p-4">
                <h3 className="font-semibold text-gray-900 dark:text-white text-sm leading-5 line-clamp-2 h-[2.5rem] overflow-hidden">
                    {product.name}
                </h3>
                ...
                {product.description && (
                    <p className="text-xs text-gray-600 dark:text-gray-400 text-sm leading-5 line-clamp-2 h-[2.5rem] overflow-hidden">
                        {product.description}
                    </p>
                )}
            </div>
